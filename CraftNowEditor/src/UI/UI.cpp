...
namespace CraftNow::UI {
		...
		ImVec2 rectMin, ImVec2 rectMax)
	{
		...
		if (ImGui::IsItemActive())
			drawList->AddImage((ImTextureID)(intptr_t)imagePressed->GetRendererID(), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintPressed);
		else if (ImGui::IsItemHovered())
			drawList->AddImage((ImTextureID)(intptr_t)imagePressed->GetRendererID(), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintHovered);
		else
			drawList->AddImage((ImTextureID)(intptr_t)imagePressed->GetRendererID(), rectMin, rectMax, ImVec2(0, 0), ImVec2(1, 1), tintNormal);
	};
